...
BALANCE: dict[str, Any] = {
    ...
    "dread_phase2_dmg_mult": 1.5,
    "dread_phase2_teleport_interval": 3,     # Turns between shadow strikes
    "dread_phase2_summon_interval": 6,       # Summon wraiths in phase 2
    "dread_phase3_aoe_damage": 5,
    "dread_phase3_torch_drain": 15,          # Torch fuel drained on phase 3 entry
    "dread_phase3_aoe_range": 3,             # Darkness AOE range
    "dread_phase3_summon_interval": 4,       # Shadow clone summon interval
    "dread_taunt_interval": 5,               # Turns between phase 1 taunts
...
VIGNETTE_TEMPLATES: list[dict[str, Any]] = [
    # --- EARLY FLOORS (1-6): Uneasy, hints of what came before ---
    {"name": "Fallen Adventurer", "char": '&', "min_floor": 1, "max_floor": 8,
     "lore": "A skeleton clutches a faded journal. The last entry reads: 'Day 7... the walls are closing in. I can hear them breathing.'",
     "loot_chance": 0.40, "loot_tier": 1},
    {"name": "Abandoned Camp", "char": '%', "min_floor": 1, "max_floor": 6,
     "lore": "A cold campfire and an empty bedroll. A half-eaten meal sits on a tin plate. Whoever was here left mid-bite.",
     "loot_chance": 0.60, "loot_tier": 1},
    {"name": "Shrine of Offerings", "char": '_', "min_floor": 1, "max_floor": 10,
     "lore": "Withered flowers and small coins lie before a crumbling idol. Someone prayed here. It didn't help.",
     "loot_chance": 0.30, "loot_tier": 1},
    {"name": "Collapsed Tunnel", "char": '#', "min_floor": 1, "max_floor": 8,
     "lore": "Rubble blocks a passage. Through a crack, you see a skeletal hand reaching toward you.",
     "loot_chance": 0.15, "loot_tier": 1},
    {"name": "Blood Trail", "char": '.', "min_floor": 1, "max_floor": 7,
     "lore": "A trail of dried blood leads to a dark alcove. It stops at the wall. There is no body.",
     "loot_chance": 0.20, "loot_tier": 1},
    {"name": "Mushroom Garden", "char": '%', "min_floor": 1, "max_floor": 8,
     "lore": "Bioluminescent fungi cast a sickly glow across a small grotto. They pulse slowly, like a heartbeat.",
     "loot_chance": 0.50, "loot_tier": 1},
    {"name": "War Memorial", "char": '|', "min_floor": 1, "max_floor": 10,
     "lore": "Names are carved deep into a stone pillar. Dozens of them. Many are scratched out — by something with claws.",
     "loot_chance": 0.15, "loot_tier": 1},
    {"name": "Rat King", "char": 'r', "min_floor": 1, "max_floor": 6,
     "lore": "A writhing mass of rat bones fused together by some dark force. Even in death, they are tangled.",
     "loot_chance": 0.25, "loot_tier": 1},
    # --- MID FLOORS (5-12): Dread builds, stories of failure ---
    {"name": "Barricaded Room", "char": '#', "min_floor": 4, "max_floor": 12,
     "lore": "Scratch marks cover the inside of a hastily barricaded door. Dozens of them. Whatever was in here... got out.",
     "loot_chance": 0.25, "loot_tier": 2},
    {"name": "Ritual Circle", "char": '*', "min_floor": 5, "max_floor": 14,
     "lore": "Melted candles surround a circle of symbols etched in dried blood. The air is warm. Something was summoned here.",
     "loot_chance": 0.50, "loot_tier": 2},
    {"name": "Empty Potion Lab", "char": '&', "min_floor": 4, "max_floor": 12,
     "lore": "Broken vials litter a workbench beside a skeleton in alchemist's robes. A note reads: 'Formula 17 — DO NOT DRINK.'",
     "loot_chance": 0.50, "loot_tier": 2},
    {"name": "Weeping Statue", "char": '*', "min_floor": 5, "max_floor": 14,
     "lore": "A marble face with tear-stained cheeks. As you watch, a fresh tear rolls down. The stone is warm.",
     "loot_chance": 0.30, "loot_tier": 1},
    {"name": "Prison Cell", "char": '#', "min_floor": 4, "max_floor": 11,
     "lore": "Chains hang from the wall. Tally marks cover every surface — walls, floor, ceiling. The last group of five is unfinished.",
     "loot_chance": 0.25, "loot_tier": 1},
    {"name": "Ancient Library", "char": '?', "min_floor": 5, "max_floor": 14,
     "lore": "Rotting bookshelves line the walls. One tome lies open: 'On the Nature of Dread — Chapter 12: There Is No Chapter 12.'",
     "loot_chance": 0.45, "loot_tier": 2},
    {"name": "Forge Remnants", "char": ')', "min_floor": 5, "max_floor": 13,
     "lore": "A cold anvil and scattered tools. A half-finished blade lies in the quench barrel. The smith never came back for it.",
     "loot_chance": 0.55, "loot_tier": 2},
    {"name": "Well of Whispers", "char": '~', "min_floor": 4, "max_floor": 12,
     "lore": "You lean over the well and hear faint whispers rising from the depths. They know your name.",
     "loot_chance": 0.30, "loot_tier": 1},
    {"name": "Cocoon Chamber", "char": 'S', "min_floor": 5, "max_floor": 13,
     "lore": "Silken cocoons hang from the ceiling. Something moves inside the largest one. You hear a muffled scream.",
     "loot_chance": 0.20, "loot_tier": 2},
    {"name": "Treasure Hoard", "char": '$', "min_floor": 4, "max_floor": 14,
     "lore": "A pile of coins surrounds a skeleton still clutching a bulging sack. Greed was the last thing to leave this one.",
     "loot_chance": 0.80, "loot_tier": 2},
    {"name": "Alchemist's Grave", "char": '!', "min_floor": 5, "max_floor": 13,
     "lore": "A headstone reads: 'Here lies one who sought the elixir of life.' Below, in a different hand: 'He found something worse.'",
     "loot_chance": 0.45, "loot_tier": 2},
    {"name": "Last Stand", "char": ')', "min_floor": 6, "max_floor": 14,
     "lore": "Three skeletons in formation, weapons drawn, backs to the wall. They died fighting together. Whatever killed them left no bones.",
     "loot_chance": 0.60, "loot_tier": 2},
    {"name": "Frozen Warrior", "char": '@', "min_floor": 6, "max_floor": 14,
     "lore": "An adventurer encased in ice, expression frozen in horror. Their eyes follow you as you pass.",
     "loot_chance": 0.50, "loot_tier": 2},
    {"name": "Broken Mirror", "char": '*', "min_floor": 5, "max_floor": 12,
     "lore": "Shattered glass reflects a hundred fractured images of yourself. In one shard, your reflection isn't moving.",
     "loot_chance": 0.20, "loot_tier": 1},
    # --- DEEP FLOORS (10-20): Horror, despair, the Dread Lord's domain ---
    {"name": "Throne of Dust", "char": '_', "min_floor": 10, "max_floor": 20,
     "lore": "A crumbling stone throne. A crown of black iron rests on the seat. You feel it watching. You feel it waiting.",
     "loot_chance": 0.35, "loot_tier": 3},
    {"name": "Dragon Scale", "char": '=', "min_floor": 10, "max_floor": 20,
     "lore": "A single massive scale, bigger than your shield. The edges are sharp enough to cut. What creature left this... and where is it now?",
     "loot_chance": 0.35, "loot_tier": 3},
    {"name": "Cursed Altar", "char": '_', "min_floor": 10, "max_floor": 20,
     "lore": "Dark stains on an obsidian altar. Fresh. The air tastes like copper and regret.",
     "loot_chance": 0.40, "loot_tier": 3},
    {"name": "Hollow Knight", "char": '&', "min_floor": 10, "max_floor": 20,
     "lore": "A full suit of armor kneels before a shattered altar. There is nothing inside it. The visor is down.",
     "loot_chance": 0.55, "loot_tier": 3},
    {"name": "Whispering Bones", "char": '%', "min_floor": 11, "max_floor": 20,
     "lore": "Bones arranged in concentric circles on the floor. They vibrate faintly. Someone whispers: 'You're almost there. Turn back.'",
     "loot_chance": 0.30, "loot_tier": 2},
    {"name": "Mirror of Fates", "char": '*', "min_floor": 12, "max_floor": 20,
     "lore": "An intact mirror in perfect condition. It shows your reflection — older, wounded, and shaking its head.",
     "loot_chance": 0.25, "loot_tier": 3},
    {"name": "The Warden's Desk", "char": '?', "min_floor": 11, "max_floor": 20,
     "lore": "A ledger lies open: rows of names, dates of entry, cause of death. The last entry is today's date. The name column is blank.",
     "loot_chance": 0.40, "loot_tier": 2},
    {"name": "Pile of Shields", "char": ')', "min_floor": 12, "max_floor": 20,
     "lore": "Dozens of shields from a dozen armies, stacked like cordwood. Every one is split down the middle by the same blow.",
     "loot_chance": 0.50, "loot_tier": 3},
    {"name": "Shadow Garden", "char": '~', "min_floor": 12, "max_floor": 20,
     "lore": "Black flowers grow from the stone floor with no soil, no light, no water. They turn to follow you.",
     "loot_chance": 0.20, "loot_tier": 2},
]
